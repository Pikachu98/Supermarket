...
<table  width = "100%" border="1" cellpadding="0" cellspacing="0" style="table-layout:fixed">
	<tr>
		<th height = "40px">订单ID</th>
		<th height = "40px">条形码</th>
		<th height = "40px">商品名</th>
		<th height = "40px">退/换货</th>
		<th height = "40px">购买数量</th>		
		<th height = "40px">退换数量</th>
		<th height = "40px">经手人</th>
	...
	<tr>
		...
		<td><%=map.get("back_type") %></td>
		<td><%=map.get("bought_count") %></td>
		<td><%=map.get("change_count") %></td>
		<td><%=map.get("processor") %></td>
	</tr>
	<%		
		}
	%>
